...
if ($redLight === true) {
    ...
    echo "Are you sure the yellow light is not on?";
}
...
if ($redLight or $yellowLight === true && $greenLight === false) {
    echo "Stop the car!";
}elseif ($redLight === false && $yellowLight === false && $greenLight === false) {
    echo "Power outage!";
}elseif ($redLight or $yellowLight === false && $greenLight === true) {
    echo "Keep moving!";
...
switch (true) {
    case $redLight or $yellowLight === true && $greenLight === false: 
      echo "Stop the car!";
      break;  	
    case $redLight === false && $yellowLight === false && $greenLight === false: 
      echo "Power outage!";
      break;  
    case $redLight or $yellowLight === false && $greenLight === true: 
      echo "Keep moving!";
      break;
